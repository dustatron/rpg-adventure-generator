...
export const eventsList: Section = {
    ...
    details:
        [
            { id: v4(), title: "Marked for death", description: "Someone wants the party dead or the party must help someone marked for death. If the target is not a party member,Check the Who section to find their identity. To find out who has ordered the target's death,Check the Opposition section" },
            { id: v4(), title: " Blackmail", description: "A character is blackmailed by an enemy.Roll on the Who section for the identity of the blackmailer.To find out what the character must do,Check the Employment section" },
            { id: v4(), title: "Escape", description: "The party has been captured and must escape or must help someone else escape capture.The characters may have been drugged and held for ransom or they may need to help a kidnapping victim.Roll on the Who section to determine who the party must assist in escaping.To determine the oppositionCheck the Opposition section" },
            { id: v4(), title: "Escape", description: " Someone runs up to the party and begs them for help.It could be a thief fleeing the wrath of their guild, or a victim fleeing a kidnapper.To determine who the party needs to help,Check the Who section.To find out who the opposition is,Check the Opposition section" },
            { id: v4(), title: "Magical affliction", description: "A character or place is struck down by an enchantment, curse, or magical event.The party must find out who is responsible and stop them before it's too late. To determine who is responsible andCheck the Who section. This person may not have cast the spell directly, but is ultimately responsible for the event.Check the Opposition section to determine who is helping them" },
            { id: v4(), title: "Witnesses", description: "The party witness a deed that has serious consequences.This could be a kidnapping, a secret meeting, or a hunt for a fugitive.To find out what the player characters seeCheck the Employment section.To discover their enemies,Check the Opposition section" }
        ]
}
...
export const civicList: Section = {
    ...
    details: [
        ...
        { id: v4(), title: 'A valuable resource runs out', description: "Food, medicine or any other vital resource has run out and the heroes must retrieve some for the community.Check the Opposition section to see who wants to prevent the party from gaining the resources." },
        ...
        { id: v4(), title: 'Unssection Portal', description: "A magical portal has appeared, connecting the city to unknown realms. The party is tasked with exploring the other side, dealing with any threats, and ensuring the portal's safe use." },
...
export const employmenList: Section = {
    id: employmentId,
    details: [
        { id: v4(), title: "Escort", description: "The party is hired to escort a person or object to another location." },
        { id: v4(), title: "Missing person", description: "A person has gone missing and the heroes have been asked to find them. This could be a lost child, a kidnapped council member or any other missing person." },
        { id: v4(), title: "Harm (or Kill)", description: "The player characters are hired to harm/kill someone or something. This includes monsters and other creatures. To find out who opposes the partyCheck the Opposition section." },
        { id: v4(), title: "Kidnap", description: "The heroes must kidnap someone. This can range from a malicious kidnapping to saving someone from a evil cult. Check who to save to determine whom the party must kidnap. ThenCheck the Opposition section to determine who opposes the adventurers." },
        { id: v4(), title: "Manhunt", description: "A person is on the run and the party is hired to bring them back. Possibilities can range from a prisoner on the run from the law, to an heir fleeing his family responsibilities. To determine who is on the run, check the who to save section. To determine the fugitive's loyalties or those helping them escape,Check the Opposition section." },
        { id: v4(), title: "Guard duty", description: "The heroes are hired to protect a person, object or place.Check the Who to determine their employer. ThenCheck the Opposition section to determine their enemies." },
        { id: v4(), title: "Spying. ", description: "The adventurers must gather information about a person or group and return with information. The task can be as simple as following a person to infiltrating a powerful organization. Check the who to save section to determine the employer. ThenCheck the Opposition section to discover who they are spying on." },
        { id: v4(), title: "Steal/Recover", description: "The characters have been hired by their employer to steal an object. To find out who they are to steal from,Check the Opposition section. Alternatively, the party's been hired to recover stolen property from a thief.Check the Opposition section to find out who committed the theft." },
        { id: v4(), title: "Courier", description: "The characters are hired to deliver a package.To find out who opposes them and wants to prevent the delivery,Check the Opposition section." },
        { id: v4(), title: "Infiltrate", description: "A group or organization has set a hideout or stronghold in an area. The adventurers must infiltrate the organization and possibly destroy it. Check the who to save section for the employer. ThenCheck the Opposition section to determine the target. To determine the strength or influence of the target, roll a 1d6." },
        { id: v4(), title: "Diplomacy", description: "Two or more factions are engaging in a war or rivalry. To prevent things from escalating, the heroes are needed to smooth things over. To determine who the aggrieved party is,Check the Opposition section." },
        ...
        { id: v4(), title: "Ransom", description: "A nosection person has been captured, and the party is hired to deliver a ransom or rescue them from their captors, facing dangers along the way." },
...
export const explorationList: Section = {
    ...
    details: [
        ...
        { id: v4(), title: "Scouting", description: "The heroes are sent on a mission to find information about the location. This can include maps, military intelligence or the location of important people.Check the Opposition section to find out who the party's adversaries are." },
        ...
        { id: v4(), title: "Lair", description: "The heroes must locate the hideout of a group or creature. They may have to infiltrate the group or slay any creature they find. If the enemy isn't a creature,Check the Opposition section to see who the party must find." },
...
export const oppositionList: Section = {
    ...
    details: [
        ...
        { id: v4(), title: "Magic user", description: "A wizard, sorcerer, cleric, or any other suisection magic user opposes the party. This also includes groups of magic users such as schools and covens." },
